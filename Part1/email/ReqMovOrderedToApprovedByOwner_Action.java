...
public class ReqMovOrderedToApprovedByOwner_Action extends TestBase {
	...
	public void ReqMovOrderedToApprovedByOwner() throws Exception{
		...
		Thread.sleep(1000);
		getWebElement("RequestNewProductsCatalogField").sendKeys("882");
		Thread.sleep(3000);
		...
		Thread.sleep(3000);
		Assert.assertTrue(driver.getPageSource().contains("Ordered Product returned to Approved"));
