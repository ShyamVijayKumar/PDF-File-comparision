...
public class ReqEditOrderedTabByMember_Action extends TestBase {
	...
	public void ReqEditOrderedTabByMember() throws Exception{
		...
		Thread.sleep(3000);
		getWebElement("OrderedTabButton").click();
		Thread.sleep(5000);
	    ...
	    Thread.sleep(2000);
	    getWebElement("OrderedEditPriceField").sendKeys("40");
	    Thread.sleep(2000);
		...
		Thread.sleep(2000);
	    getWebElement("OrderedAddNotes2").click();
	    Thread.sleep(2000);
	    getWebElement("OrderedEditNoteField").click();
	    Thread.sleep(2000);
	    getWebElement("OrderedEditNoteField").clear();
	    Thread.sleep(2000);
	    getWebElement("OrderedEditNoteField").sendKeys("Note3");
	    Thread.sleep(2000);
		...
		Thread.sleep(8000);
		getWebElement("MoveToApprovedLink").click();
		Thread.sleep(6000);
