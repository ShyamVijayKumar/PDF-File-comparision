...
public class ReqEditOrderedTabByManager_Action extends TestBase {
	...
	public void ReqEditOrderedTabByManager() throws Exception{
	    ...
	    Thread.sleep(2000);
	    getWebElement("OrderedEditPriceField").sendKeys("30");
	    Thread.sleep(2000);
	    ...
	    Thread.sleep(2000);
	    getWebElement("OrderedEditNoteField").sendKeys("Note2");
	    Thread.sleep(2000);
