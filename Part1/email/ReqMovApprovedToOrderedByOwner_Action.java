...
public class ReqMovApprovedToOrderedByOwner_Action extends TestBase {
	...
	public void ReqMovApprovedToOrderedByOwner() throws Exception{
		...
		Thread.sleep(1000);
		getWebElement("RequestNewProductsCatalogField").sendKeys("753");
		Thread.sleep(3000);
		...
		Thread.sleep(3000);
		Assert.assertTrue(driver.getPageSource().contains("Requested product ordered"));
