...
public class ReqEditCountPriceNoteByManager_Action extends TestBase {
	...
	public void ReqEditCountPriceNoteByManager() throws Exception{
	    ...
	    Thread.sleep(2000);
	    getWebElement("RequestEditPriceField").sendKeys("30");
	    Thread.sleep(2000);
		...
		Thread.sleep(3000);
		getWebElement("MailinatorPublicInbox1").click();
		Thread.sleep(3000);
		getWebElement("FirstMessage").click();
		Thread.sleep(3000);
		driver.switchTo().frame("msg_body");
	    ...
	    Thread.sleep(2000);
	    getWebElement("RequestEditNoteField").sendKeys("Note2");
	    Thread.sleep(2000);
