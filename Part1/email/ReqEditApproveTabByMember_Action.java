...
public class ReqEditApproveTabByMember_Action extends TestBase {
	...
	public void ReqEditApproveTabByMember() throws Exception{
	    ...
	    Thread.sleep(2000);
	    getWebElement("ApproveEditPriceField").sendKeys("40");
	    Thread.sleep(2000);
	    ...
	    Thread.sleep(2000);
	    getWebElement("ApproveEditNoteField").sendKeys("Note3");
	    Thread.sleep(2000);
