...
public class ReqMovOrderedToInventoryByManager_Action extends TestBase {
	...
	public void ReqMovOrderedToInventoryByManager() throws Exception{
		...
		Thread.sleep(1000);
		getWebElement("RequestNewProductsCatalogField").sendKeys("755");
		Thread.sleep(3000);
		...
		Thread.sleep(5000);
		getWebElement("MoveToInventoryLink").click();
		...
		Thread.sleep(3000);
		Assert.assertTrue(driver.getPageSource().contains("Requested product received"));
	    ...
	    Thread.sleep(2000);
	    getWebElement("DeleteRadioButton").click();
	    Thread.sleep(2000);
