...
public class ValidationMessage_EditShippingAddress extends TestBase
{
	@Test
	public void ValidationMessage_EditShippingInfo() throws Exception
	{
		...
		if(Res == false) {
			...
			CartRegularFunctions EditShippingInfo = new CartRegularFunctions();
			EditShippingInfo.Validation_EditShippingAddress();
		}
		else {
