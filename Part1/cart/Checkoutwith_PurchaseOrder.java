...
public class Checkoutwith_PurchaseOrder extends TestBase
{
	@Test
	public void CheckoutPurchaseOrder() throws Exception
	{
		...
		if(Res == false) {
			...
			if(getWebElement("PurchaseOrderRadiobuttonOn").isDisplayed()) {
				CartRegularFunctions POCheckout = new CartRegularFunctions();
				POCheckout.CheckoutwithPurchaseOrder();
			}
			/*else {
				getWebElement("PurchaseOrderRadiobuttonOff")
				getWebElement("PurchaseOrderRadiobuttonOff").click();
				CartRegularFunctions POCheckout = new CartRegularFunctions();
				POCheckout.CheckoutwithPurchaseOrder();
			}*/
		}
			...
			/*
				...
				getWebElement("PurchaseOrderRadiobuttonOnOff").click();
				getWebElement("PurchaseOrderRadiobuttonOff").click();
				CartRegularFunctions POCheckout = new CartRegularFunctions();
				POCheckout.CheckoutwithPurchaseOrder();
			}*/
