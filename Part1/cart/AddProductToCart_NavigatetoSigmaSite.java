...
public class AddProductToCart_NavigatetoSigmaSite extends TestBase
{
	@Test
	public void AddProducttocartNavigatetoSigmaSite() throws Exception
	{
		...
		if(Res == true) {
			...
			//Open Sigma Page
			CartRegularFunctions OpenSigmaPage = new CartRegularFunctions();
			OpenSigmaPage.VerifySigmaAldrichPage();
		}
		else {
