...
public class AddProductToCart_ChangePacksize extends TestBase
{
	@Test
	public void AddProducttocartChangePacksize() throws Exception
	{
...
if(Res == true) {
	//System.out.println("isEmpty() res is TRUE");
		...
		//Update product Packsize
		CartRegularFunctions UpdatePacksize = new CartRegularFunctions();
		UpdatePacksize.UpdateProductPacksize();
}
else {
