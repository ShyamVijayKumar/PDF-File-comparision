...
public class ValidationMessage_CartPage_EditContactInfo extends TestBase
{
	@Test
	public void ValidationMessage_EditContactInfo() throws Exception
	{
		...
		if(Res == false) {
			...
			EditContactInfo.Validation_EditandverifyContactInfo();
		}
		else {
