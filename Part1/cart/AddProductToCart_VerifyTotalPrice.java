...
public class AddProductToCart_VerifyTotalPrice extends TestBase
{
	@Test
	public void AddProducttocartVerifyTotalPrice() throws Exception
	{
...
if(Res == true) {
	//System.out.println("isEmpty() res is TRUE");
		...
		//Verify Total Price
		CartRegularFunctions VerifyTotal = new CartRegularFunctions();
		VerifyTotal.VerifyTotalPrice();
}
else {
